...
def make_labels_dogids(ts_raw,dog_names,labels_dict_fname="labels_2018_aug_01.dms"):
...
def get_raw_ts(fname_labels="labels_2018_aug_01.dms",fname_data="sensedog_2019_sept19_ts_all.csv"):
